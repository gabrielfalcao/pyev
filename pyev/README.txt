...
relative timers (:py:class:`Timer`), absolute timers with customised
rescheduling (:py:class:`Periodic`), synchronous signals (:class:`Signal`),
process status change events (:py:class:`Child`), and event watchers dealing
with the event loop mechanism itself (:py:class:`Idle`, :py:class:`Embed`,
:py:class:`Prepare` and :py:class:`Check` watchers) as well as file watchers
(:py:class:`Stat`) and even limited support for fork events (:py:class:`Fork`).
